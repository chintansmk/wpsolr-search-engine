 ...
 *
 * Class WPSOLR_UI_Result_Row
 */
class WPSOLR_UI_Result_Row extends WPSOLR_UI {
	...
	public function __construct() {
		...
		$this->component_type = WPSOLR_Options_Components::COMPONENT_TYPE_RESULTS_ROWS;
		$this->layout_type    = WPSOLR_Options_Layouts::TYPE_LAYOUT_RESULT_ROW_GROUP;
	}
	...
	protected function extract_data() {
		...
		return WPSOLR_Data_Result_Row::extract_data( $this->group_id );
	}
