...
<div class="wdm_row">
	...
	<div class='col_right'>
		...
		<select
			name="<?php echo sprintf( '%s[%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Schemas::FORM_FIELD_SOLR_INDEX_ID ); ?>">
			<?php
...
<div class="wdm_row">
	...
	<div class='col_right'>
		...
		<p>
			The query will use the index with schema '<?php echo $fields_name; ?>' that matches the
