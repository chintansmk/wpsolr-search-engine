	...
	jQuery(document).ready(function () {
		...
		jQuery('[name=save_selected_index_options_form]').click(function () {
			...
			$fields_checkboxes_concatenated = [
				WPSOLR_Options_Fields::OPTION_FIELDS_POST_TYPES,
				WPSOLR_Options_Fields::OPTION_FIELDS_ATTACHMENTS,
				WPSOLR_Options_Fields::FORM_FIELD_TAXONOMIES
			];
		...
		jQuery(".<?php echo WPSOLR_Options_Fields::OPTION_FIELDS_CUSTOM_FIELDS ?> input:checkbox").click(function () {
	...
	<?php foreach ( $groups as $group_uuid => $group ) {
		...
		<div id="<?php echo $group_uuid; ?>">
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<?php
					$indexes_selected = ! empty( $group[ WPSOLR_Options_Fields::OPTION_FIELDS_SOLR_INDEXES ] ) ? $group[ WPSOLR_Options_Fields::OPTION_FIELDS_SOLR_INDEXES ] : [ ];
					foreach ( $indexes as $index_id => $index ) {
						?>
						<div class='wpsolr-3col'>
							<input type='checkbox'
							       name="<?php echo sprintf( '%s[%s][%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::OPTION_FIELDS_SOLR_INDEXES, $index_id ); ?>"
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<?php $value = isset( $group[ WPSOLR_Options_Fields::OPTION_FIELDS_ARE_POST_EXCERPTS_INDEXED ] ); ?>
					<input type='checkbox'
					       name="<?php echo sprintf( '%s[%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::OPTION_FIELDS_ARE_POST_EXCERPTS_INDEXED ); ?>"
					       value='1'
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<?php $value = isset( $group[ WPSOLR_Options_Fields::OPTION_FIELDS_IS_SHORTCODE_EXPANDED ] ); ?>
					<input type='checkbox'
					       name="<?php echo sprintf( '%s[%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::OPTION_FIELDS_IS_SHORTCODE_EXPANDED ); ?>"
					       value='1'
						<?php echo checked( $value ); ?>>
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<?php
					$indexed_items = ! empty( $group[ WPSOLR_Options_Fields::OPTION_FIELDS_POST_TYPES ] ) ? $group[ WPSOLR_Options_Fields::OPTION_FIELDS_POST_TYPES ] : [ ];
					foreach ( $indexable_post_types as $indexable_item ) {
						?>
						<div class='wpsolr-4col'>
							<input type='checkbox'
							       name="<?php echo sprintf( '%s[%s][%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::OPTION_FIELDS_POST_TYPES, $indexable_item ); ?>"
					...
					<div class="wpsolr_overflow">
						...
						if ( count( $indexable_custom_fields ) > 0 ) {
							foreach ( $indexable_custom_fields as $indexable_custom_field ) {
								...
								$selected_custom_fields  = ! empty( $group[ WPSOLR_Options_Fields::OPTION_FIELDS_CUSTOM_FIELDS ] ) ? $group[ WPSOLR_Options_Fields::OPTION_FIELDS_CUSTOM_FIELDS ] : [ ];
								...
								<div class='wpsolr-1col'>
									<div
										class='wpsolr-2col <?php echo WPSOLR_Options_Fields::OPTION_FIELDS_CUSTOM_FIELDS ?>'>
										<input
											type='checkbox'
											name="<?php echo sprintf( '%s[%s][%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::OPTION_FIELDS_CUSTOM_FIELDS, $indexable_custom_field ); ?>"
									...
									<div class="<?php echo $indexable_custom_field; ?>"
										...
										<select style="<?php if ( ! $is_indexed_custom_field ) {
											...
											<?php if ( ! $is_indexed_custom_field ) {
											    ...
											    name="<?php echo sprintf( '%s[%s][%s][%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::OPTION_FIELDS_CUSTOM_FIELDS, $indexable_custom_field, 'solr_type' ); ?>"
										<?php
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<div class="wpsolr_overflow">
						<?php
						$indexed_items = ! empty( $group[ WPSOLR_Options_Fields::OPTION_FIELDS_ATTACHMENTS ] ) ? $group[ WPSOLR_Options_Fields::OPTION_FIELDS_ATTACHMENTS ] : [ ];
						foreach ( $allowed_attachments_types as $indexable_item ) {
							...
							<div class='wpsolr-2col'>
								<input type='checkbox'
								       value='<?php echo $indexable_item ?>'
								       name="<?php echo sprintf( '%s[%s][%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::OPTION_FIELDS_ATTACHMENTS, $indexable_item ); ?>"
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<div>
						<?php
						$indexed_items = ! empty( $group[ WPSOLR_Options_Fields::FORM_FIELD_TAXONOMIES ] ) ? $group[ WPSOLR_Options_Fields::FORM_FIELD_TAXONOMIES ] : [ ];
						if ( count( $taxonomies ) > 0 ) {
							foreach ( $taxonomies as $indexable_item ) {
								...
								<div class='wpsolr-2col'>
									<input type='checkbox'
									       name="<?php echo sprintf( '%s[%s][%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::FORM_FIELD_TAXONOMIES, $indexable_item ); ?>"
									       value='<?php echo $indexable_item; ?>'
										<?php checked( ( ! empty( $indexed_items[ $indexable_item ] ) ) ); ?>>
									<?php echo $indexable_item ?>
								</div>
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<?php $value = isset( $group[ WPSOLR_Options_Fields::FORM_FIELD_IS_INDEX_COMMENTS ] ); ?>
					<input type='checkbox'
					       class="is_default"
					       name="<?php echo sprintf( '%s[%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::FORM_FIELD_IS_INDEX_COMMENTS ); ?>"
					       value='1'
						<?php echo checked( $value ); ?>>
				</div>
				<div class="clear"></div>
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<?php $value = isset( $group[ WPSOLR_Options_Fields::OPTION_FIELDS_EXCLUDE_IDS ] ) ? $group[ WPSOLR_Options_Fields::OPTION_FIELDS_EXCLUDE_IDS ] : ''; ?>
					<input type="text"
					       name="<?php echo sprintf( '%s[%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Fields::OPTION_FIELDS_EXCLUDE_IDS ); ?>"
