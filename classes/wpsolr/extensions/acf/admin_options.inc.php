	...
	<form action="options.php" method="POST" id='extension_groups_settings_form'>
		...
		<div class='wrapper'>
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<input type='checkbox'
					       name='<?php echo $options_name; ?>[<?php echo WPSOLR_Option::OPTION_PLUGIN_ACF_IS_REPLACE_CUSTOM_FIELD_NAME; ?>]'
					       value='<?php echo WPSOLR_Option::OPTION_PLUGIN_ACF_IS_REPLACE_CUSTOM_FIELD_NAME; ?>'
						<?php WPSOLR_Service_Wordpress::checked( WPSOLR_Option::OPTION_PLUGIN_ACF_IS_REPLACE_CUSTOM_FIELD_NAME, isset( $options[ WPSOLR_Option::OPTION_PLUGIN_ACF_IS_REPLACE_CUSTOM_FIELD_NAME ] ) ? $options[ WPSOLR_Option::OPTION_PLUGIN_ACF_IS_REPLACE_CUSTOM_FIELD_NAME ] : '', true ); ?>>
				</div>
				<div class="clear"></div>
			</div>
