...
class WPSOLR_Options_Indexes extends WPSOLR_Extensions {
	...
	protected function post_constructor() {
		...
		$this->_options = WPSOLR_Global::getOption()->get_option_indexes();
	}
	...
	/**
	 * How many solr index of type temporary ?
	 *
	 * @return bool
	 */
	public function count_index_type_temporary() {
	...
	/**
	 * Are we allowed to add another temporary index ?
	 *
	 * @return bool
	 */
	public function can_add_another_index_type_temporary() {

		// Max 2.
		return ( $this->count_index_type_temporary() < 2 );
	}
	...
	public function build_solarium_config( &$solr_index_indice = null, $language_code = null, $timeout ) {
		...
		if ( ! isset( $solr_index_indice ) ) {
			...
			$solr_index_indice = apply_filters( WPSOLR_Filters::WPSOLR_FILTER_SEARCH_GET_DEFAULT_SOLR_INDEX_INDICE, null, $language_code );
