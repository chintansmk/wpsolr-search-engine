...
<div class="wdm_row wpsolr_facet_type wpsolr_<?php echo WPSOLR_Options_Facets::FACET_TYPE_CUSTOM_RANGE; ?>">

	<input type='hidden'
	       name='<?php echo $facet_option_array_name; ?>[<?php echo WPSOLR_Options_Facets::FACET_FIELD_TYPE; ?>]'
	       value='<?php echo WPSOLR_Options_Facets::FACET_TYPE_CUSTOM_RANGE; ?>'/>
	...
	<div class='col_right'>
				...
				><?php echo esc_attr( $facet_custom_range_ranges ); ?></textarea>
