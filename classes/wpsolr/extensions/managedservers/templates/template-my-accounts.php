...
<div class="wdm-vertical-tabs-content">
	<div class="wrapper">
		...
		if ( count( $subtab_exploded ) >= 2 ) {
			...
			$subtab_exploded = explode( ':', $subtab );
			WPSOLR_Extensions::require_with( WPSOLR_Extensions::get_option_template_file( WPSOLR_Extensions::OPTION_MANAGED_SOLR_SERVERS, 'template-my-account-indexes.php' ), array(
