				...
				foreach ( WPSOLR_Global::getExtensionIndexes()->get_indexes() as $solr_index_indice => $solr_index ) {
					...
					<div class="wdm_row">
						...
						<div class='col_right'>
							...
							Is indexing: &nbsp;
							<select
								name='<?php echo $options_name; ?>[solr_index_indice][<?php echo $solr_index_indice ?>][indexing_language_code]'>
							...
							<input type='checkbox'
							       name='<?php echo $options_name; ?>[solr_index_indice][<?php echo $solr_index_indice ?>][is_default_search]'
							       value='1'
								<?php
