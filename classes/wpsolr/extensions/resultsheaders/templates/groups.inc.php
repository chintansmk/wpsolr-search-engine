	...
	<?php foreach ( $groups as $group_uuid => $group ) {
		...
		<div id="<?php echo $group_uuid; ?>">
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<?php $value = isset( $group[ WPSOLR_Options_Result_Header::FORM_FIELD_IS_INFINITESCROLL ] ); ?>
					<input type="checkbox"
					       name="<?php echo sprintf( '%s[%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Result_Header::FORM_FIELD_IS_INFINITESCROLL ); ?>"
						<?php checked( $value ); ?>
					/>
				</div>
				<div class="clear"></div>
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<?php $value = isset( $group[ WPSOLR_Options_Result_Header::FORM_FIELD_MAX_NB_RESULTS_BY_PAGE ] ) ? $group[ WPSOLR_Options_Result_Header::FORM_FIELD_MAX_NB_RESULTS_BY_PAGE ] : WPSOLR_Options_Result_Header::FORM_FIELD_DEFAULT_MAX_NB_RESULTS_BY_PAGE; ?>
					<input type="text"
					       name="<?php echo sprintf( '%s[%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Result_Header::FORM_FIELD_MAX_NB_RESULTS_BY_PAGE ); ?>"
			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<?php $value = isset( $group[ WPSOLR_Options_Result_Header::FORM_FIELD_HIGHLIGHTING_FRAGSIZE ] ) ? $group[ WPSOLR_Options_Result_Header::FORM_FIELD_HIGHLIGHTING_FRAGSIZE ] : WPSOLR_Options_Result_Header::FORM_FIELD_DEFAULT_HIGHLIGHTING_FRAGSIZE; ?>
					<input type="text"
					       name="<?php echo sprintf( '%s[%s][%s]', $options_name, $group_uuid, WPSOLR_Options_Result_Header::FORM_FIELD_HIGHLIGHTING_FRAGSIZE ); ?>"
					       value="<?php echo esc_attr( $value ); ?>"
					/>
				</div>
				<div class="clear"></div>
