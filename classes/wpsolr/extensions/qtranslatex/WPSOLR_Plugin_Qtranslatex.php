...
namespace wpsolr\extensions\qtranslatex;

use wpsolr\extensions\WPSOLR_Extensions;

// Load WPML class for inheritance
WPSOLR_Extensions::is_extension_to_be_loaded( WPSOLR_Extensions::EXTENSION_WPML, true );

/**
 * Manage qTranslateX plugin
 * @link https://qtranslatexteam.wordpress.com/interface/
 */
class WPSOLR_Plugin_Qtranslatex extends WPSOLR_Plugin_Wpml {
	...
	function __construct() {
		...
		/*
		add_filter( WPSOLR_Filters::WPSOLR_FILTER_SEARCH_PAGE_SLUG, array(
			$this,
