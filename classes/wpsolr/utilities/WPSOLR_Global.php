...
class WPSOLR_Global {
	...
	/**
	 * @return WPSOLR_Options_Shortcodes
	 */
	public static function getExtensionShortcodes() {
		return self::getObject( WPSOLR_Extensions::OPTION_SHORTCODES, WPSOLR_Extensions::CLASS, WPSOLR_Extensions::OPTION_SHORTCODES );
	}
}
